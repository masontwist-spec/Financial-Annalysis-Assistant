    ...
    <section className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
      <div className="pixel-panel space-y-6 p-6 sm:p-8">
        <div className="space-y-3">
          <p className="text-sm font-black uppercase tracking-[0.25em] text-neutral-700">Welcome</p>
          <h1 className="pixel-title text-4xl font-black uppercase sm:text-6xl">Investment Gates</h1>
          <p className="max-w-2xl text-lg font-bold text-neutral-800">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <article className="pixel-card p-5">
            <p className="text-sm font-black uppercase tracking-[0.2em] text-neutral-700">Focus</p>
            <h2 className="mt-3 text-xl font-black">Disciplined gating</h2>
            <p className="mt-2 font-bold text-neutral-800">Review each dimension of the business before forming a conviction.</p>
          </article>

          <article className="pixel-card p-5">
            <p className="text-sm font-black uppercase tracking-[0.2em] text-neutral-700">Design</p>
            <h2 className="mt-3 text-xl font-black">Clean research flow</h2>
            <p className="mt-2 font-bold text-neutral-800">A modern, responsive interface built to organize and compare thesis areas.</p>
          </article>
        </div>
      </div>
      ...
      <aside className="pixel-panel space-y-6 p-6 sm:p-8">
        <div className="space-y-3">
          <p className="text-sm font-black uppercase tracking-[0.25em] text-neutral-700">Core gates</p>
        ...
        <ul className="space-y-3 font-bold">
          {[
            ...
            <li key={gate} className="border-2 border-black bg-white px-4 py-3 shadow-pixel">
              {gate}
            </li>
          ))}
        </ul>
